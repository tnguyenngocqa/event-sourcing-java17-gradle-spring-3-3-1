...
public class BorrowingSaga {
    ...
    private void handler(BookUpdateStatusEvent event) {
        ...
        try {
            ...
            log.info("BookUpdateStatusEvent in Saga - done query for GetDetailEmployeeQuery");
            ...
            log.info("BookUpdateStatusEvent in Saga - done query for EmployeeResponseCommonModel");
